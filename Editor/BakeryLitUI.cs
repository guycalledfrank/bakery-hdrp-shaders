...
{
    public class BakeryLitGUI : BaseLitGUI
    {
        ...
        protected static class Styles
        {
            ...
            // Bakery
            public static string bakeryLabelText = "Bakery options";
        ...
        protected void DoBakeryGUI(Material material)
        {
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(Styles.bakeryLabelText, EditorStyles.boldLabel);
            EditorGUI.indentLevel++;
