Shader "HDRenderPipeline/Bakery Lit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "BakeryHDRP_GBuffer.hlsl"
        ...
        Pass
        {
            ...
            #pragma multi_compile _ DYNAMICLIGHTMAP_ON
            #pragma multi_compile _ SHADOWS_SHADOWMASK
            // #include "HDRP/Lighting/Forward.hlsl"
        ...
        Pass
        {
            ...
            #include "HDRP/Material/Lit/LitData.hlsl"
            //#include "HDRP/ShaderPass/ShaderPassForward.hlsl"
            #include "BakeryHDRP_Forward.hlsl"
    ...
    CustomEditor "Experimental.Rendering.HDPipeline.BakeryLitGUI"
}
